...
public class ProfileFragment extends Fragment implements ChangeColorListner {
	...
	public static LinearLayout mProfileTopContainer;
	private static PhotosFragment photosFragment;
	public static int topContainerHieght;
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		mProfileTopContainer = (LinearLayout) view
				.findViewById(R.id.profile_top_container);
	...
	static class SamplePagerItem {
		...
		Fragment createFragment() {
			if (mPosition == 0) {
				...
				photosFragment.setHideListener(hideListener);
	...
	private static OnScrollHideListener hideListener = new OnScrollHideListener() {

		@Override
		public void onHideFromFragmentToActivity() {

			mProfileTopContainer.animate().translationY(-mProfileTopContainer.getHeight())
		...
		public void onShowFraomFragmentToActivity() {
			...
			mProfileTopContainer.animate().translationY(0)
