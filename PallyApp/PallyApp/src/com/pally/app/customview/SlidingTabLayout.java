...
package com.pally.app.customview;
...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private ChangeColorListner changeColorListner;
	...
	private class InternalViewPagerListener implements
		...
		public void onPageSelected(int position) {
			...
			if (changeColorListner != null) {
				changeColorListner.onChangeColorCompleted(position);
			}
		}
	...
	public void setColorChangeListner(ChangeColorListner changecolorlistner) {
		changeColorListner = changecolorlistner;
	}
}
